angular.module('test.httpBackend', ['http-auth-interceptor','ngMockE2E'])
  .run(function($ionicPlatform, $rootScope, $httpBackend, $http) {
    ...
    var holidays = [
      { title: 'Daddy day', id: 1, variant: 'Private', status: 'Requested' },
      { title: 'Long weekend', id: 2, variant: 'Private', status: 'Requested' },
      { title: 'Trip to Japan', id: 3, variant: 'Private', status: 'Approved'  },
      { title: 'Christmas', id: 4, variant: 'Public', status: 'Requested' },
    ];
